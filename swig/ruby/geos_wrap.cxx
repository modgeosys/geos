...
SWIGEXPORT void Init_geos(void) {
  ...
  rb_define_const(mGeos, "GEOS_VERSION_MINOR", SWIG_From_int(static_cast< int >(1)));
  rb_define_const(mGeos, "GEOS_VERSION_PATCH", SWIG_From_int(static_cast< int >(0)));
  rb_define_const(mGeos, "GEOS_VERSION", SWIG_FromCharPtr("3.1.0"));
  ...
  rb_define_const(mGeos, "GEOS_CAPI_VERSION_MINOR", SWIG_From_int(static_cast< int >(4)));
  rb_define_const(mGeos, "GEOS_CAPI_VERSION_PATCH", SWIG_From_int(static_cast< int >(1)));
  rb_define_const(mGeos, "GEOS_CAPI_FIRST_INTERFACE", SWIG_From_int(static_cast< int >(1)));
  rb_define_const(mGeos, "GEOS_CAPI_LAST_INTERFACE", SWIG_From_int(static_cast< int >((1+4))));
  rb_define_const(mGeos, "GEOS_CAPI_VERSION", SWIG_FromCharPtr("3.1.0-CAPI-1.4.1"));
